  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      {onPlanChange && (
        ...
        >
          <div style={{ fontSize: 12, fontWeight: 700, color: colors.textSub, marginBottom: 8 }}>
            조회 플랜
          </div>
          <Segmented
            size="small"
      ...
      >
        <div style={{ fontSize: 13, fontWeight: 700, color: colors.textBase, marginBottom: 12 }}>
          최근 조회 이력
        </div>
        {recent.length === 0 ? (
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            {recent.map((r, i) => (
              ...
              >
                <ClockCircleOutlined
                  style={{ fontSize: 12, color: colors.textHint, flexShrink: 0 }}
                />
                <span
                  style={{
                    flex: 1,
      ...
      {isMember ? (
        ...
        >
          ...
          <div
            style={{ fontSize: 12.5, color: colors.textSub, margin: "6px 0 12px", lineHeight: 1.5 }}
          >
